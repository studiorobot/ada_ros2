...
> You are currently on the **main** branch, which uses the **Ada Gen3**
> robot configuration.
>
> To use the **Gen2 (Jaco2) robot**, please checkout or clone the
> **`jaco2` branch** instead.
>
> This adaptation replaces the original `ada_moveit` configuration
